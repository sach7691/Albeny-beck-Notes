...
import java.io.IOException;
    ...
    public class Conference1 {
            ...
            switch (menuId) {
                ...
                case 2:{
                  ...
                  case 3:{
                    ...
                    if(event1 != null){
                        conference1.writeToFile(event1);
                    }else{
                  ...
                  case 4:{
                    ...
                    conference1.writeToFile(events);
                    break;
                  }
                  case 5:{
                  ...
                  case 6:{
                    ...
                    int eventId = conference1.getInput("Enter Event Id :");
                    conference1.addAttendees(attendees, attendeeId, eventId);
                    System.out.println(attendees.toString());
                    break;
                  }
                  case 7:{
        ...
        public ArrayList<Attendees> addAttendees(ArrayList<Attendees> attendees,int attendeeId,int eventId){
            ...
            for(Attendees at: attendees1){
                System.out.println("Hey");
                System.out.println(attendees1.contains(at.getAttendId()));

                if(attendees1.contains(at.getAttendId())){
                ...
                Attendees a = new Attendees(e.getEventId(), e.getEventName(), e.getEventLocation(), e.getEventTimeDate(), attendeeId, aName, aAddress, aPhoneNumber);
            ...
            System.out.println(isAttendeeFound);
            System.out.println(isEventFound);
            if(isAttendeeFound || isEventFound){
                
                System.out.println("Attendee is Found or an Event Not Found, Cannot Add Attendees !! ");
            }
        ...
        public void writeToFile(ArrayList<Events> events){
            ...
            try{
                ...
                bw = new BufferedWriter(fw);
                ArrayList<Events> event1 = new ArrayList<>();


                for (int i = 0; i < event1.size(); i++) {
                    System.out.println(events.get(i).overWrite());
                    bw.write(events.get(i).overWrite());
                    bw.flush();
                }            
